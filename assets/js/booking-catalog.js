...
(function (global) {
  ...
  const SUSPENSION_SERVICES = [
    ...
    {
      id: "air_fork_off",
      label: "Air fork revalve and service — forks off the bike",
      priceLabel: "A$1080",
      price: 1080,
      location: "off_bike",
      pickupBikes: 0,
      ...
      includesShockSpring: false,
      includes: [
        "Air forks supplied loose/off the bike",
        "Air fork service",
        "Fork revalve",
        "Setup based on rider weight and riding type",
        "No fork springs (air forks)",
        "Wear parts extra if needed",
      ],
    },
    {
      id: "air_fork_shock_off",
      label: "Air fork revalve and shock service — forks and shock off the bike",
      priceLabel: "A$1260",
      price: 1260,
      location: "off_bike",
      pickupBikes: 0,
      ...
      includesShockSpring: false,
      includes: [
        "Air forks and shock supplied loose/off the bike",
        "Air fork service",
        "Fork revalve",
        "Shock service",
        "Setup based on rider weight and riding type",
    ...
    {
      id: "air_fork_on",
      label: "Air fork revalve and shock service — complete bike (quote first)",
